...
if (isset($_SESSION['role'])) {
    if ($_SESSION['role'] === 'vip' && $nombre_total_articles >= 2) {
        ...
        $message_reduction = " La Claaaasseeee ! Offre VIP Appliquée : Un smoothie gratuit déduit du total hehe ! ";
    }
    elseif ($_SESSION['role'] === 'premium') {
        $reduction = $total_de_base * 0.10;
        $total_de_base = $total_de_base - $reduction;
        $message_reduction = "Yeaaaaaa ! Avantage Premium Appliqué : 10% de réduction immédiate hihi ! ";
    }
}
...
<section class="formsection">
    <div class="formcontainer">
        ...
        <?php if (isset($_SESSION['role']) && $_SESSION['role'] === 'vip' && $nombre_total_articles >= 2): ?>
            <p style="color: green; font-weight: bold;">✨ Offre VIP Appliquée : Un smoothie gratuit déduit du total ! ✨</p>
        <?php endif; ?>
