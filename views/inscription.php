...
<section class="formsection">
    ...
    <div class="formgroup">
        <div>
            ...
            <span id="error-prenom" class="error-message" style="color: red; font-size: 13px; display: none; text-align: left; margin-top: -5px; margin-bottom: 5px;"></span>
        </div>
        <div>
            <input type="text" id="nom" name="nom" placeholder="Nom" required>
            <span id="error-nom" class="error-message" style="color: red; font-size: 13px; display: none; text-align: left; margin-top: -5px; margin-bottom: 5px;"></span>
        </div>
    </div>

    <input type="email" id="email" name="email" placeholder="Email" required>
    <span id="error-email" class="error-message" style="color: red; font-size: 13px; display: none; text-align: left; margin-top: -5px; margin-bottom: 5px;"></span>

    <input type="tel" id="telephone" name="telephone" placeholder="Numéro de téléphone" required>
    <span id="error-telephone" class="error-message" style="color: red; font-size: 13px; display: none; text-align: left; margin-top: -5px; margin-bottom: 5px;"></span>
    ...
    <span id="error-adresse" class="error-message" style="color: red; font-size: 13px; display: none; text-align: left; margin-top: -5px; margin-bottom: 5px;"></span>

    <div class="formgroup">
        <div>
            <input type="text" id="code_postal" name="code_postal" placeholder="Code Postal" required>
            <span id="error-code_postal" class="error-message" style="color: red; font-size: 13px; display: none; text-align: left; margin-top: -5px; margin-bottom: 5px;"></span>
        </div>
        <div>
            <input type="text" id="ville" name="ville" placeholder="Ville" required>
            <span id="error-ville" class="error-message" style="color: red; font-size: 13px; display: none; text-align: left; margin-top: -5px; margin-bottom: 5px;"></span>
        </div>
    </div>
